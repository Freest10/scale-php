...
class Page
{
    ...
    public function getChildPages($options)
    {
        ...
        $joinOrderString = $this->getSqlStringToJoinOrder($sortTable);
        $orderString = $this->getSqlStringForOrder($sortTable, $orderBy);
    ...
    private function getSqlStringToJoinOrder($sortTable)
    {
        $joinOrderString = "";
        if ($sortTable) {
            $joinOrderString = "INNER JOIN " . $sortTable . " AS tblbytype ON pprnt1.id = tblbytype.page_id ";
        }
    ...
    private function getSqlStringForOrder($sortTable, $orderBy, $sortBySortNum)
    {
        if (!$orderBy) {
            $orderBy = 'ASC';
        }
